          ...
          <div className="granciare__booking-grid">
            <div className="granciare__booking-info">
              ...
              <div className="contact-options mt-32">
                <a href="https://wa.me/393520730769" target="_blank" rel="noreferrer" className="contact-option">
                ...
                <a href="tel:+390763630996" className="contact-option">
                  <span className="contact-option__icon">☎</span>
                  <div>
                    <span className="contact-option__label">Phone</span>
                    <span className="contact-option__value">+39 0763 630996</span>
                  </div>
                </a>
              </div>
            </div>
