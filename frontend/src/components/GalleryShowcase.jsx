...
const showcases = [
  {
    ...
    captions: [
      ...
      'Cypress trees with ornamental gate & valley view',
      'Estate glimpsed through woodland',
      'Open lawn with estate & cypress',
      'Granciare agriturismo sign, olive grove & cypress',
      'Hilltop view — gardens, chapel & Umbrian mountains',
      'Garden terrace with terracotta pots & iron furniture',
      'Cypress alley with ornamental gate & valley panorama',
      'Cobblestone path between stone buildings & cypress',
      'Cypress alley at golden hour — ornamental gate & hills',
      'Cypress trees & ornamental gate at sunrise',
    ],
  },
  {
    name: 'Pool & Amenities',
    ...
    captions: [
      ...
      'Pool — elevated terrace view & valley',
      'Pool — estate facade, sunloungers & Umbrian hills',
      'Kitchen — marble island, decorative tiles & beamed ceiling',
      'Dining room — wooden tables & stone fireplace',
      'Pool terrace with cypress trees, stone wall & valley',
      'Outdoor dining — iron table under stone arch',
      'Pool panorama — sunloungers, cypress & rolling hills',
      'Pool at sunrise — sunloungers & cypress',
      'Pool at dusk — sunloungers & clear sky',
      'Pool terrace — cypress trees & hazy valley',
      'Pool terrace at dusk — garden lights & flowers',
      'Pool at dawn — weather vane & valley panorama',
    ],
  },
  {
    name: 'Rooms & Suites',
    ...
    captions: [
      ...
      'Bedroom — iron bed, antique mirror dresser & wooden closets',
      'Bedroom — ornate carved bed with gold inlay',
      'Living room — stone arch, brown sofa & colourful rug',
      'Bedroom — ornate iron bed & antique dresser',
      'Bathroom — tiled walls, bidet & sink with blue bottles',
      'Study room — antique desk, leather chairs & green sofa',
    ],
  },
];
