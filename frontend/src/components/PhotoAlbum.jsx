...
const CATEGORIES = [
  ...
  },
  {
    ...
    images: [
      ...
      '/images/mansion/mansion-rooftop-dusk-moon.jpeg',
      '/images/mansion/mansion-stone-arch-lantern.jpeg',
      '/images/mansion/mansion-rooftop-flowers-dusk.jpeg',
      '/images/mansion/mansion-estate-golden-hour.jpeg',
      '/images/mansion/mansion-estate-aerial-dusk.jpeg',
      '/images/mansion/mansion-stone-staircase.jpeg',
      '/images/mansion/mansion-red-flowers-tower-dusk.jpeg',
      '/images/mansion/mansion-arch-cypress-garden.jpeg',
      '/images/mansion/mansion-rooftop-sunset.jpeg',
      '/images/mansion/mansion-rooftop-terrace-dusk.jpeg',
      '/images/mansion/mansion-arch-lantern-vertical.jpeg',
      '/images/mansion/mansion-rooftop-dusk-cypress.jpeg',
      '/images/mansion/mansion-rooftop-flower-stand.jpeg',
      '/images/mansion/mansion-white-flower-moon.jpeg',
    ],
  },
  {
    key: 'landscape',
    ...
    images: [
      ...
      '/images/landscape/landscape-1.jpeg',
      '/images/landscape/landscape-2.jpeg',
      '/images/landscape/landscape-3.jpeg',
      '/images/landscape/landscape-4.jpeg',
      '/images/landscape/landscape-5.jpeg',
      '/images/landscape/landscape-6.jpeg',
      '/images/landscape/showcase.jpeg',
      '/images/landscape/cobblestone-path-cypress-valley.jpeg',
      '/images/landscape/cypress-gate-golden-hour.jpeg',
      '/images/landscape/cypress-gate-sunrise.jpeg',
    ],
  },
  {
    key: 'pool',
    ...
    images: [
      ...
      '/images/pool/showcase.jpeg',
      '/images/pool/pool-sunrise-cypress.jpeg',
      '/images/pool/pool-dusk-sunloungers.jpeg',
      '/images/pool/pool-terrace-cypress-hazy.jpeg',
      '/images/pool/pool-evening-lights-flowers.jpeg',
      '/images/pool/pool-dawn-weathervane-valley.jpeg',
    ],
  },
  {
    key: 'dining',
  ...
  },
  {
    ...
    images: [
      ...
      '/images/rooms/room-1.jpeg',
      '/images/rooms/room-2.jpeg',
      '/images/rooms/room-4.jpeg',
    ],
  },
  {
    key: 'living',
  ...
  },
  {
    ...
    images: [
      ...
      '/images/olive-oil/olive-oil-extraction-centrifuge-flow.jpeg',
      '/images/olive-oil/olive-oil-extraction-closeup.jpeg',
      '/images/olive-oil/olive-oil-mill-machinery.jpeg',
      '/images/olive-oil/olive-oil-bottling-cases.jpeg',
      '/images/olive-oil/olive-oil-bottling-pallets.jpeg',
      '/images/olive-oil/olive-oil-fresh-pressed-flow.jpeg',
      '/images/olive-oil/olive-oil-extraction-threads.jpeg',
      '/images/olive-oil/olive-harvest-branch-black-olives.jpeg',
      '/images/olive-oil/olive-grove-autumn.jpeg',
      '/images/olive-oil/olive-harvest-nets.jpeg',
      '/images/olive-oil/olive-harvest-fallen-olives.jpeg',
      '/images/olive-oil/solivé-dubai-gold-award-certificate.png',
      '/images/olive-oil/solivé-best-olive-oils-store-logo.png',
      '/images/olive-oil/solivé-best-olive-oils-italy-logo.png',
      '/images/olive-oil/solivé-dubaiooc-logo.png',
      '/images/olive-oil/solivé-gold-award-2026.png',
      '/images/olive-oil/solivé-ultra-premium-evoo-logo.png',
      '/images/olive-oil/solivé-best-olive-oils-store-display.png',
      '/images/olive-oil/solivé-bottle-500ml.png',
    ],
  },
];
